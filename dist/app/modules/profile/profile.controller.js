...
const getProfile = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const reqUserId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.userId;
    const result = yield profile_services_1.ProfileService.getProfile(reqUserId);
    const resultWithoutPassword = {
        ...
        contactNo: result === null || result === void 0 ? void 0 : result.contactNo,
